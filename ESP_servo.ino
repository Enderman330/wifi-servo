...
#define ServoPortB  D2      //--> Defining Servo Port 2

#define LED1        D3      //--> Defining LED
                            //wifi name and password as access point

const char* ssid = "Servo";  // your SSID

const char* password = "enderman330";     //WIFI Password


Servo myservo;  //--> create servo object to control a servo
Servo myservoB; //--> create another servo
...
void setup() {
  ...
  myservoB.attach(ServoPortB); //--> attaches the servo on D2 to the servo object
  pinMode(LED1, OUTPUT);
